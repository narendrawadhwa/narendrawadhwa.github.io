    ...
    if (!isRotating) {
      ...
      switch (true) {
        case normalizedRotation >= 4.35 && normalizedRotation <= 4.75:
          setCurrentStage(1);
          break;
        case normalizedRotation >= 3.7 && normalizedRotation <= 4:
          setCurrentStage(2);
          break;
        ...
        case normalizedRotation >= 2.4 && normalizedRotation <= 2.6:
          setCurrentStage(4);
          break;
        case normalizedRotation >= 1.6 && normalizedRotation <= 1.9:
          setCurrentStage(5);
          break;
        ...
        case normalizedRotation >= 6.15 && normalizedRotation <= 6.45:
          setCurrentStage(7);
          break;
