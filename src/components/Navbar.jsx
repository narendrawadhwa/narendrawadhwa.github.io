...
<header className='header'>
    <NavLink to="/3D_Portfolio_App/" className='px-2 py-1 rounded-lg text-[14px] bg-white items-center justify-center flex font-bold shadow-md'>
        <p className='blue-gradient_text'>
          NARENDRAs
        <br/>WORLD
        </p>
    </NavLink>
    <nav className='flex text-base gap-7 text-[16px] font-medium'>
